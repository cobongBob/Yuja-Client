  ...
  return (
    <div className='tableWrapper'>
      ...
      <div className='myPage-tableBox'>
        ...
        >
          <Col xs={8} md={8}>
            <MyPageYoutuberTable boardData={boardData} userData={userData} board_code={1} />
          </Col>
          <Col xs={4} md={4}>
        ...
        >
          <Col xs={6}>
            <MyPagePortfolioTable boardData={boardData} board_code={2} userData={userData} />
          </Col>
          <Col xs={6}>
            <MyPagePortfolioTable boardData={boardData} board_code={3} userData={userData} />
          </Col>
        </Row>
      </div>
    </div>
