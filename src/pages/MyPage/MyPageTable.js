  ...
  return (
    <div className='tableWrapper'>
      ...
      <table className='myPage-box'>
        ...
        <MyPageYoutuberTable boardData={boardData} board_code={2} />
      </table>
      <h3> 썸네일러 포트폴리오 </h3>
      <table className='myPage-box'>
        <thead>
        ...
        <MyPageYoutuberTable boardData={boardData} board_code={3} />
      </table>
      <h3> 자유게시판 </h3>
      <table className='myPage-box'>
        <thead>
        ...
        <MyPageYoutuberTable boardData={boardData} board_code={4} />
      </table>
    </div>
  );
};
