...
const MyPageTable = ({
  ...
  const youtubeLikeHandler = useCallback(
    ...
    [userData, dispatch, youtubeLikeList]
  );
  ...
  const portFolioLikeHandler = useCallback(
    ...
    [userData, dispatch, editorLikeList, thumbLikeList]
  );
  ...
  const freeLikeHandler = useCallback(
    ...
    [userData, dispatch, freeLikeList]
  );

  return (
    <div className='tableWrapper'>
      {console.log(3, yCurrentData.length)}
      {(console.log(4, youtubeLikeList), console.log(5, yCurrentData))}
