...
class YapiService {
  ...
  async fetchBoard(board_id) {
    return await axios.get(USER_API_BASE_URL + BoardType + "/board/" + board_id);
  }

  async modifyBoard(board_id, data) {
    return await axios.put(USER_API_BASE_URL + BoardType + "/board/" + board_id, data);
  }

  async deleteBoard(board_id) {
    return await axios.delete(USER_API_BASE_URL + BoardType + "/board/" + board_id);
  }
}
